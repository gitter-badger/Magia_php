...
<ul>
    ...
    <li><a href="index.php?p=configBd">Copiar base.sql (grupos, idiomas, paginas, permisos, usuarios)</a></li>
    <li><a href="index.php?p=config">Define donde vas a crear los plugins</a></li>
