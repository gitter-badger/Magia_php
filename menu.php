<h1><?php echo $tabla; ?></h1>
    ...
    <ul>
        ...
        <ul>                                        
            ...
            <li><a href="magia.php?p=v_borrar&tabla=<?php echo "$tabla"; ?>">borrar.php </a></li>  
            <li><a href="magia.php?p=v_buscarr&tabla=<?php echo "$tabla"; ?>">buscar.php </a></li>  
            ...
            <li><a href="magia.php?p=v_ver&tabla=<?php echo "$tabla"; ?>">ver.php</a></li>  
