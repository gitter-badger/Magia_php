 ...
 <div class="form-group"> 
     <label for="parametro" class="col-sm-2 control-label">parametro</label> 
     <div class="col-sm-10"> 
       <input type="text" class="form-control" name="parametro" id="parametro" placeholder="parametro" value="<?php echo parametro; ?>"> 
     </div> 
   </div> 
 <div class="form-group"> 
