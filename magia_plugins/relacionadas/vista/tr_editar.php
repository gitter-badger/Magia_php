 <?php  
$borrar = (permisos_tiene_permiso("borrar", "relacionadas", $u_grupo))?'<a class="btn btn-danger" href="index.php?p=relacionadas&c=borrar&a=borrar&id='.$id.'">Borrar</a>':''; ?>
...
<form method="post" action="index.php" >
 ...
 <td><input class="form-control" type="text" name="funcion_relacionada" value="<?php echo $funcion_relacionada; ?>" placeholder=""></td> 
