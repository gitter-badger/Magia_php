 <?php  
$borrar = (permisos_tiene_permiso("borrar", "extructura", $u_grupo))?'<a class="btn btn-danger" href="index.php?p=extructura&c=borrar&a=borrar&id='.$id.'">Borrar</a>':''; ?>
...
<form method="post" action="index.php" >
 ...
 <td><input class="form-control" type="text" name="valor_entrega" value="<?php echo $valor_entrega; ?>" placeholder=""></td> 
 <td><input class="form-control" type="text" name="errores" value="<?php echo $errores; ?>" placeholder=""></td> 
