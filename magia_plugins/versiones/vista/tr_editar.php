 <?php  
$borrar = (permisos_tiene_permiso("borrar", "versiones", $u_grupo))?'<a class="btn btn-danger" href="index.php?p=versiones&c=borrar&a=borrar&id='.$id.'">Borrar</a>':''; ?>
...
<form method="post" action="index.php" >
 ...
 <td><input class="form-control" type="text" name="nombre" value="<?php echo $nombre; ?>" placeholder=""></td> 
